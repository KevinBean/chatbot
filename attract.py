...
def findinFiles(filename, sample): #使用tfidf
...
filename = [u'doc/SM021C-A11-01.txt', u'doc/SL351C-A11-01.txt'] # u'doc/管廊缆线敷设技术条件.docx'
dictpath = u'dict/SM021C-A11-01.txt'
